...
public class ActionRoll : IronswornRoll
{
  ...
  public override EmbedFieldBuilder ScoreField() => base.ScoreField().WithName("Action Score");
  ...
  public SelectMenuBuilder MakeMenu()
  {
    return new SelectMenuBuilder()
      .WithCustomId($"action-roll-menu:{ActionDie.Value},{Stat},{Adds},{ChallengeDie1.Value},{ChallengeDie2.Value},{Momentum}")
      ;
    // reroll challenge die 1
    // reroll challenge die 2
    // reroll action die
    //
    // set action die face
    // set challenge die face
    //
  }
}