...
public abstract class IronswornRoll
{
  ...
  public string OutcomeText()
  {
    ...
    return Outcome switch
    {
      ...
      IronswornRollOutcome.WeakHit => IronswornRollResources.WeakHit,
      IronswornRollOutcome.StrongHit => IronswornRollResources.StrongHit,
      _ => "ERROR",
    };
  }
  ...
  public virtual string ScoreLabel { get => IronswornRollResources.Score; }

  // <summary>A string description of the roll type (e.g. "Progress Roll", "Action Roll"), for use in labelling output.</summary>
  public virtual string RollTypeLabel { get => IronswornRollResources.Roll; }
}