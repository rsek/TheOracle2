...
public abstract class IronswornRoll
{
  ...
  public int Score { get => Math.Min(ScoreMax, RawScore); }
  ...
  public string OverMaxMessage() => RawScore > ScoreMax ? string.Format(IronswornRollResources.OverMaxMessage, Score) : "";
